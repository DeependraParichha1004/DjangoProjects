...
class Keras_Facenet(models.Model):
    ...
    person_name = models.CharField(max_length=200)  # for more features makemigrations
    image = models.ImageField(upload_to='pics/',null=True,max_length=200)
...
# facenet=Keras_Facenet()
# model_new=facenet('data/train/','data/val/','data/val/Deependra/WhatsApp Image 2022-10-03 at 5.42.53 PM (2).jpeg')
# joblib.dump(model_new,'keras_facenet.pkl')
#
